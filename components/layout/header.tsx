...
import { PathNameContext } from "../providers/theme-provider";
...
const Header = () => {
  ...
  const links: ThemeLink[] = [
    { name: "/images/Dark.png", theme: "dark" },
    { name: "/images/Light.png", theme: "light" },
    { name: "/images/system.png", theme: "system" },
  ];
  ...
  const handleTheme = (newTheme: ThemeName): void => {
    cycleOpen();
      ...
      <AnimatePresence>
        ...
        >
          <div className="cursor-pointer bg-[#343434] hover:text-neutral-700 border-neutral-600 border border-t-0 w-[110px] flex-col overflow-hidden rounded-b-xl break-all">
            ...
            >
              {hoverTheme ? (
                <p className="transition-all uppercase font-bold ease-out duration-700">
                  {hoverTheme}
                </p>
              ) : (
